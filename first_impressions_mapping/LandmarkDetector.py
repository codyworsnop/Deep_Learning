...
class LandmarkDetector():
    ...
    def get_landmarks(self, image, image_path):
        ...
        if any(faces):
            ...
            #Nates code here 
            OpenFaceBashCommand = '/home/cody/Documents/OpenFace/build/bin/FaceLandmarkImg -2Dfp -wild -f ' + image_path + ' -out_dir ' + landmark_output_directory
